...
if sys.platform == "win32":
    ...
    #includeDependencies = [ ("/usr/lib/libblas/libblas.so.3gf.0","libblas.so.3gf"),("/usr/lib/liblapack.so.3gf.0","liblapack.so.3gf"), ("/usr/lib/libgfortran.so.3","libgfortran.so.3"), ("/etc/matplotlibrc","matplotlibrc")] #,( matplotlib.get_data_path(),"mpl-data"),]
...
#/usr/lib/pymodules/python2.6/mdp/utils/slideshow.css
#/usr/share/pyshared/mdp/utils/slideshow.css
